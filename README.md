...
5. Una vez completo es hora de revisar lo que construimos con Github Copilot, para ello primero subamos los cambios a Fabric. Desde la terminal en el folder del proyecto ejecuta `npm rayfin up` (este comando es el que sube los cambios de local a Fabric)
